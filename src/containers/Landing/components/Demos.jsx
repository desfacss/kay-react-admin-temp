  ...
  <section className="landing__section landing__section--demos">
    ...
    <Container>
      ...
      <Row className="landing__demo-wrap">
        <Col lg={8}>
          <Link className="landing__demo" target="_blank" to="/scheduler">
        ...
        <Col lg={4} className="landing__demo-theme-toggle">
          <p className="landing__demo-title">Scheduler</p>
          <DemoThemeToggle theme={theme} changeToLight={changeToLight} changeToDark={changeToDark} />
        </Col>
      </Row>
      <Row className="landing__demo-wrap">
        <Col lg={8}>
          <Link className="landing__demo" target="_blank" to="/views">
            <div className="landing__demo-img-wrap">
              <img src={theme.className === 'theme-dark' ? onlineMarketingDark : onlineMarketing} alt="" />
            </div>
          </Link>
        ...
        <Col lg={4} className="landing__demo-theme-toggle">
          <p className="landing__demo-title">Views</p>
          <DemoThemeToggle theme={theme} changeToLight={changeToLight} changeToDark={changeToDark} />
        </Col>
      </Row>
      <Row className="landing__demo-wrap">
        <Col lg={8}>
          <Link className="landing__demo" target="_blank" to="/kanban">
            <div className="landing__demo-img-wrap">
              <img src={theme.className === 'theme-dark' ? onlineMarketingDark : onlineMarketing} alt="" />
            </div>
          </Link>
        ...
        <Col lg={4} className="landing__demo-theme-toggle">
          <p className="landing__demo-title">Kanban</p>
          <DemoThemeToggle theme={theme} changeToLight={changeToLight} changeToDark={changeToDark} />
        </Col>
      </Row>
      <Row>
        <Col lg={8}>
          <Link className="landing__demo" target="_blank" to="/strategy">
            <div className="landing__demo-img-wrap">
              <img src={theme.className === 'theme-dark' ? onlineMarketingDark : onlineMarketing} alt="" />
            </div>
          </Link>
        ...
        <Col lg={4} className="landing__demo-theme-toggle">
          <p className="landing__demo-title">Strategy</p>
          <DemoThemeToggle theme={theme} changeToLight={changeToLight} changeToDark={changeToDark} />
        </Col>
      </Row>
      <Row className="landing__demo-wrap">
